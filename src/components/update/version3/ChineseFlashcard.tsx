...
// // --- Motivational Quotes ---
// // Put your 100 quotes into this array:
...
//   { text: '成大事者，不恤小耻。', author: 'Chinese Proverb' },
//   { text: '学如逆水行舟，不进则退。', author: 'Chinese Proverb' },
//   // ...add the rest of your quotes here up to 100
// ];

// --- Vocabulary Sets ---

const vocabularySets: { id: string; label: string; data: VocabularyItem[] }[] = [
  { id: 'batch1', label: '基础1–100', data: zw01 },
  { id: 'batch2', label: '基础101–200', data: zw02 },
  { id: 'batch3', label: '基础201–300', data: zw03 },
  { id: 'batch4', label: '基础301–400', data: zw04 },
  { id: 'batch5', label: '基础401–500', data: zw05 },
  { id: 'batch6', label: '基础501–600', data: zw06 },
  { id: 'batch7', label: '基础601–700', data: zw07 },
  { id: 'batch8', label: '基础701–800', data: zw08 },
  { id: 'batch9', label: '基础801–900', data: zw09 },
  { id: 'batch10', label: '基础901–1000', data: zw10 },
  { id: 'batch11', label: 'wuLi', data: wuli01 },
  { id: 'batch12', label: 'Wuli31-60', data: wuli02 },
  { id: 'batch13', label: 'wuli61-85', data: wuli03 },
  { id: 'batch14', label: 'math1-50', data: math01 },
  { id: 'batch15', label: 'math51-69', data: math02 },
];
...
export default function ChineseFlashcardApp() {
  ...
  // Random initial quote when page loads
  useEffect(() => {
  ...
  // Quote auto-rotation every 5 minutes when enabled
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col items-center py-8 px-4 font-sans text-slate-800">
      ...
      <header className="mb-4 text-center">
        ...
        <p className="text-slate-500 mt-2 text-sm">Daniel Ding 学好中文，好幸运</p>
      </header>
      ...
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-lg overflow-hidden border border-slate-200">
        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <div className="w-full bg-slate-50 rounded-xl p-4 border border-slate-100 text-left relative group">
            ...
            <p className="text-sm text-slate-600">{currentCard.sentenceMeaning}</p>
          </div>
        </div>
      ...
      <div className="mt-6 text-center text-slate-400 text-sm max-w-xs">
        <p>
          ...
          from any word. Use the dropdown to switch vocabulary sets.
        </p>
      </div>
    </div>
  );
